...
source("03a_priprava_dat_UZS_JZS.R", echo = T)
source("03b_priprava_dat_DRG.R", echo = T)
source("03c_priprava_dat_spoj_data.R", echo = T)
if (sprav_vylucenie_zlucenych) {
  source("03d_priprava_dat_vyluc_zlucene_hosp.R", echo = T)
}
